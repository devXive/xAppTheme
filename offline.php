				...
				<fieldset>
					<label>
						<span class="block input-icon input-icon-right">
							<input name="username" type="text" class="span12" alt="<?php echo JText::_('TPL_XAPPTHEME_USERNAME'); ?>" placeholder="<?php echo JText::_('TPL_XAPPTHEME_USERNAME'); ?>" required />
							<i class="icon-user"></i>
						</span>
					</label>
					<label>
						<span class="block input-icon input-icon-right">
							<input type="password" name="password" class="span12" alt="<?php echo JText::_('TPL_XAPPTHEME_PASSWORD'); ?>" placeholder="<?php echo JText::_('TPL_XAPPTHEME_PASSWORD'); ?>" required />
							<i class="icon-lock"></i>
						</span>
					</label>
					<div class="space"></div>
